    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="index2.html" class="logo">
                ...
                <span class="logo-mini"><b>VO</b>TE</span>
                <!-- logo for regular state and mobile devices -->
                <span class="logo-lg"><b>VOTE</b></span>
            </a>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <img src="{{ asset('temp/dist/img/user2-160x160.jpg') }}" class="user-image"
                                    alt="User Image">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    <img src="{{ asset('temp/dist/img/user2-160x160.jpg') }}" class="img-circle"
                                        alt="User Image">
            ...
            <section class="sidebar">
                ...
                <div class="user-panel">
                    ...
                    <div class="pull-left info">
                        <p>{{ auth()->user()->name }}</p>
                        <!-- Status -->
                        <a href="#"><i class="fa fa-circle text-success"></i> {{ auth()->user()->keterangan }}</a>
                    </div>
                </div>
